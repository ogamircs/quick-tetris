...
from .constants import (
    ...
    DIFFICULTY_SETTINGS, COLORS, TETROMINOS, WALL_KICKS,
    INITIAL_FALL_SPEED, SOFT_DROP_SPEED, LOCK_DELAY,
    DAS_DELAY, DAS_REPEAT, HARD_DROP_ANIM_SPEED, LINE_CLEAR_ANIM_DURATION,
...
from .music import generate_tetris_music
